...
class TrajectoryPublisher(Node):
    ...
    def __init__(self):
        ...
        self.trajectory_publisher = self.create_publisher(JointTrajectory,"/robot_trajectory/joint_trajectory", 10)


    def timer_callback(self):

        # creating a point
        goal_positions_1 = [math.pi/3,math.pi/3,math.pi/4,math.pi/3]
        goal_positions_2 = [0.0,0.0,0.0,0.0 ]
